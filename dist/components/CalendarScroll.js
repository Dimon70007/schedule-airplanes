  ...
  _createClass(CalendarScroll, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var _props = this.props,
          oldSelectedIndex = _props.selectedIndex,
          scrolledIndex = _props.scrolledIndex,
          oldPosition = _props.scrolledPosition;
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          width = _props3.width,
          scrollTo = _props3.scrollTo,
          overscanCount = _props3.overscanCount,
          childWidth = _props3.childWidth,
          height = _props3.height,
          scrolledPosition = _props3.scrolledPosition,
          scrolledIndex = _props3.scrolledIndex,
          selectedIndex = _props3.selectedIndex,
          selectIndex = _props3.selectIndex,
          otherProps = _objectWithoutProperties(_props3, ['Child', 'children', 'width', 'scrollTo', 'overscanCount', 'childWidth', 'height', 'scrolledPosition', 'scrolledIndex', 'selectedIndex', 'selectIndex']);
