...
export var SCROLL_ACTIONS = ['SCROLL_LEFT', 'SCROLL_RIGHT', 'DROPDOWN_SCROLL', 'SCROLL_TO'];
...
export var fetchData = function fetchData(payload) {
  ...
  return function (dispatch) {
    ...
    var fetcher = getFetcher(payload);
    dispatch(getData());
