...
export var forecastUrl1 = 'https://openweathermap.org/data/2.5/forecast/daily';
...
export var fetchForecastWeather = function fetchForecastWeather() {
  return function (_ref2) {
    ...
    return getWeather(forecastUrl, _extends({}, getForecastQuery(), query));
  };
};
...
export var fetchHistoryWeather = function fetchHistoryWeather(startDate) {
  ...
  return function (_ref3) {
    ...
    return getWeather(historyUrl, _extends({}, historyQuery, query));
  };
};
...
var getWeather = function getWeather() {
  ...
  var urlWithParams = mergeurlQuery(newPath, query);
